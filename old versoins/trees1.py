...
class Tree:
    ...
    def find_last_topics(self):
        ...
        write_topics_to_xl("1-3.xlsx", self.last_nodes)
        write_tz(self)
    ...
    def unite_similar_topics(self):
        ...
        write_topics_with_freq("1-1.xlsx", self.roots, with_children=False)
    ...
    def unite_by_countries(self):
        ...
        write_topics_to_xl("1-4.xlsx", self.last_nodes, with_children=True)
