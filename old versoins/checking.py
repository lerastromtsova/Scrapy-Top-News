...
from trees import write_topics_to_xl

def write_here_to_xl(fname, nodes):
...
nodes -= to_remove
write_here_to_xl("проверка.xlsx", nodes)
...
write_topics_to_xl("финальное.xlsx", nodes, with_children=True)
most_similar = []
...
while nodes:
    ...
    while others:
        ...
        common_docs = [nd for nd in node.documents for od in other.documents if nd.translated['title'] == od.translated['title']]
...
write_topics_to_xl("по новостям.xlsx", nodes, with_children=True)
